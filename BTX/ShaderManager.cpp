...
void ShaderManager::Init(void) 
{
	...
	CompileShader(pFolder->GetFolderShaders() + "BTX.vs", pFolder->GetFolderShaders() + "Wireframe.fs", "Wireframe");
	...
	//Compile BTX shader
	CompileShader(pFolder->GetFolderShaders() + "BTX.vs", pFolder->GetFolderShaders() + "Simplex.fs", "BTX");
