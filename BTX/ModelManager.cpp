...
void ModelManager::Init(void)
{
	...
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBERED] = GenerateUniWireCube(C_RED);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEGREEN] = GenerateUniWireCube(C_GREEN);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEBLUE] = GenerateUniWireCube(C_BLUE);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEWHITE] = GenerateUniWireCube(C_WHITE);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEYELLOW] = GenerateUniWireCube(C_YELLOW);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBECORNFLOWER] = GenerateUniWireCube(C_BLUE_CORNFLOWER);
	
	//special colored spheres
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHERERED] = GenerateUniWireSphere(C_RED);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREGREEN] = GenerateUniWireSphere(C_GREEN);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREBLUE] = GenerateUniWireSphere(C_BLUE);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREWHITE] = GenerateUniWireSphere(C_WHITE);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREYELLOW] = GenerateUniWireSphere(C_YELLOW);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHERECORNFLOWER] = GenerateUniWireSphere(C_BLUE_CORNFLOWER);

	SetWireCubeThickness(3.0f);
	SetWireSphereThickness(1.0f);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHERERED]->SetLineWidth(5.0f);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBERED]->SetLineWidth(1.5f);
}

void ModelManager::SetWireCubeThickness(float a_fLineWidth)
{
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBERED]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEGREEN]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEBLUE]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEWHITE]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBEYELLOW]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::CUBECORNFLOWER]->SetLineWidth(a_fLineWidth);
}
void ModelManager::SetWireSphereThickness(float a_fLineWidth)
{
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHERERED]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREGREEN]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREBLUE]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREWHITE]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHEREYELLOW]->SetLineWidth(a_fLineWidth);
	g_pShape[BTX::eBTX_SPECIALMODEL::SPHERECORNFLOWER]->SetLineWidth(a_fLineWidth);
}
...
//--- Add to render list
void ModelManager::AddSpecialToRenderList(BTX::eBTX_SPECIALMODEL a_eSelection, matrix4 a_m4ToWorld)
{
