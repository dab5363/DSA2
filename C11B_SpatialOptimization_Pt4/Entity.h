...
class Entity
{
	...
	BTX::Model* m_pModel = nullptr; //Model associated with this Entity
	...
	BTX::ModelManager* m_pModelMngr = nullptr; //For rendering shapes
...
public:
	...
	*/
	Entity(BTX::Model* a_pModel, String a_sUniqueID = "NA");
