...
class Application
{
	BTX::Model* m_pModel = nullptr;
private:
	String m_sToPrint = "Hi there, hello!";
	BTX::String m_sProgrammer = "Alberto Bobadilla - labigm@rit.edu";
	static ImGuiObject gui; //GUI object

	BTX::uint m_uRenderCallCount = 0; //count of render calls per frame

	BTX::vector3 m_v3Mouse = BTX::vector3(); //position of the mouse in the window
	bool m_bFPC = false;// First Person Camera flag
	bool m_bArcBall = false;// Arcball flag
	BTX::quaternion m_qArcBall; //ArcBall quaternion

	BTX::vector4 m_v4ClearColor; //Color of the scene
...
#pragma region Constructor / Run / Destructor
	...
	*/
	...
	OUTPUT: ---
	*/
	void Init(BTX::String a_sApplicationName = "", int a_uSize = BTX::eBTX_RESOLUTIONS::RES_C_1280x720_16x9_HD,
	...
	OUTPUT: ---
	*/
	void Init(BTX::String a_sApplicationName, BTX::uint a_uWidth, BTX::uint a_uHeight, bool a_bFullscreen, bool a_bBorderless);
...
#pragma region Initialization / Release
	...
	OUTPUT: ---
	*/
	void InitWindow(BTX::String a_sWindowName = "Application");
...
#pragma region Main Loop
	...
	*/
	...
	OUTPUT: ---
	*/
	void ClearScreen(BTX::vector4 a_v4ClearColor = BTX::vector4(-1.0f));
#pragma endregion
