...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	//implement your own solution.
	 ...
	 float ra, rb;
    matrix3 R, AbsR;
	vector3 localX = vector3(this->GetModelMatrix()[0][0], this->GetModelMatrix()[0][1], this->GetModelMatrix()[0][2]);
	vector3 localY = vector3(this->GetModelMatrix()[1][0], this->GetModelMatrix()[1][1], this->GetModelMatrix()[1][2]);
	vector3 localZ = vector3(this->GetModelMatrix()[2][0], this->GetModelMatrix()[2][1], this->GetModelMatrix()[2][2]);
    ...
    t = vector3(glm::dot(t, localX), glm::dot(t, localY), glm::dot(t, localZ));
